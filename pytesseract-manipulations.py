...
final_correct_countries = {
    ('austtia', 'austfia', 'austtid', 'autivia'): 'austria',
    ('aorway', 'nnorway'): 'norway',
    ('taly', 'ttaly', 'aly'): 'italy'
}

lst = ['austfia', 'austtid', 'autivia', 'aorway', 'nnorway', 'ttaly', 'aly']

# print(*final_correct_countries.values())
#
# for c in lst:
#     for t in final_correct_countries.keys():
#         if c in t:
#             print(final_correct_countries[t])